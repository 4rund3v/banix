    ...
    <React.Fragment>
      ...
      <Card className="email-leftbar">
        ...
        <div className="mail-list mt-1">
          <Link to="#">
            <span className="mdi mdi-circle-outline text-info float-right"></span>
            Theme Support
          </Link>
          <Link to="#">
            <span className="mdi mdi-circle-outline text-warning float-right"></span>
            Freelance
          </Link>
          <Link to="#">
            <span className="mdi mdi-circle-outline text-primary float-right"></span>
            Social
          </Link>
          <Link to="#">
            <span className="mdi mdi-circle-outline text-danger float-right"></span>
            Friends
          </Link>
          <Link to="#">
            <span className="mdi mdi-circle-outline text-success float-right"></span>
            Family
          </Link>
        </div>
