                ...
                <Table hover className=" mb-0 table-centered table-nowrap">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p className="text-muted mb-0">Rs. 2478</p>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        <p className="text-muted mb-0">Rs. 2625</p>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        <h5 className="font-size-14 mb-0">Led Bulb</h5>
                      </td>
                      <td>
                        <div id="spak-chart3"></div>
                      </td>
                      <td>
                        <p className="text-muted mb-0">Rs. 2,856</p>
                      </td>
                    </tr>
                  </tbody>
                </Table>
