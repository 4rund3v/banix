        ...
        <div className="container">
          <div className="document">
            <div className="document__header">
              <h1 className="document__title">Returns</h1>
            ...
            <div className="document__content typography">
              ...
              <p>
                ...
                complete product with packaging &amp; accessories. The cost of
                any missing or damaged items (including the box) apart from
                those notified by you, will be debited from the advance payment
                done &amp; the remaining payment will be refunded. If a
                replacement is demanded, then the cost of any missing items need
                to be paid in advance, prior to the shipment of the replacement.
              </p>
              <br />
              <h3>
                How do I return my package? Do I need to include anything?
              </h3>
              <p>
              ...
              <ul>
                ...
                <li>
                  The goods must not have been used, Protective films on
                  products must be intact and must be complete with all
                  components and the packaging must not be damaged. Note that if
                  these conditions are not met we may not accept returned goods;
                </li>
                <li>
              ...
              <p>
                ...
                email contact us to get return instructions. Any packages
                returned without our authorization are subject to being returned
                to sender. We recommend you use a tracking service for all
                returns.
                <br />
                The returned merchandise must be sent back in its original
                packaging and returned in the same condition as when sold to
                you, including all packaging, parts, accessories, manuals, and
                documentation. The returned item(s) must be repackaged properly
                so that it is not damaged during shipping.
                <br />
