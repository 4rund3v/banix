...
function SocialLinks(props) {
  ...
  const items = [
    {
      type: "facebook",
      url: theme.author.fb_profile_url,
      icon: "fab fa-facebook-f",
    },
    {
      type: "twitter",
      url: theme.author.twitter_profile_url,
      icon: "fab fa-twitter",
    },
    {
      type: "youtube",
      url: theme.author.youtube_profile_url,
      icon: "fab fa-youtube",
    },
    {
      type: "instagram",
      url: theme.author.instagram_profile_url,
      icon: "fab fa-instagram",
    },
    {
      type: "linkedin",
      url: theme.author.linkedin_profile_url,
