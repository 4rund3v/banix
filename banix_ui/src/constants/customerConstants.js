...
export const CUSTOMER_LOGIN_STATUS_REQUEST = "CUSTOMER_LOGIN_STATUS_REQUEST";
export const CUSTOMER_LOGIN_STATUS_SUCCESS = "CUSTOMER_LOGIN_STATUS_SUCCESS";
export const CUSTOMER_LOGIN_STATUS_FAIL = "CUSTOMER_LOGIN_STATUS_FAIL";
