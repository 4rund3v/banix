...
export const loginStatusCheck = () => async (dispatch, getState) => {
    try {
        ...
        if (!customerInfo) {
            throw new Error(
                "Customer Info not found, cannot check status of token"
            );
        }
        const config = {
            headers: {
...
export const updateCustomerDetails = (customer) => async (
    ...
    try {
        ...
        console.log(
            "[updateCustomerDetails] The customer token is :: ",
            tokenInfo
        );
        const config = {
            headers: {
...
export const createCustomerAddress = (customerAddress) => async (
    ...
    try {
        ...
        console.log(
            "[createCustomerAddress] The customer token is :: ",
            tokenInfo
        );
        const config = {
            headers: {
...
export const updateCustomerAddress = (modifiedCustomerAddress) => async (
    ...
    try {
        ...
        console.log(
            "[updateCustomerAddress] The customer token is :: ",
            tokenInfo
        );
        const config = {
            headers: {
