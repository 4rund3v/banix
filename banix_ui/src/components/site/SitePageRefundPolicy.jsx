        ...
        <div>
            ...
            <div className="document">
                ...
                <div className="document__content typography">
                    ...
                    <p>
                        Refunds: We will process the refund once the user
                        initates the refund request.
                        <br />
                        Regarding the payment refund
                        <ul>
                            <li>
                                Refund will be processed based on the mode of
                                payment and will be refunded within 7 working
                                days.
                            </li>
                            <li>
                                In case of Cash On Delivery : We will send a
                                refund cheque. The cheque will be made in favor
                                of the name as in the "billing name" provided at
