      ...
      <div className="document">
        ...
        <div className="document__content typography">
          ...
          <p>
            ...
            visitor request. Banix purpose in collecting non-personally
            identifying information is to better understand how Banix visitors
            use its website. From time to time, Banix may release
            non-personally-identifying information in the aggregate, e.g., by
            publishing a report on trends in the usage of its website. Banix
            also collects potentially personally-identifying information like
            Internet Protocol (IP) addresses for logged in users and for users
            leaving comments on banix.in blogs/sites. Banix only discloses
            logged in user and commenter IP addresses under the same
            circumstances that it uses and discloses personally-identifying
            information as described below, except that commenter IP addresses
            and email addresses are visible and disclosed to the administrators
            of the blog/site where the comment was left.
          </p>
          <h3>Gathering of Personally-Identifying Information</h3>
          <p>
            Certain visitors to Banix's websites choose to interact with Banix
            in ways that require Banix to gather personally-identifying
            information. The amount and type of information that Banix gathers
            depends on the nature of the interaction. For example, we ask
            visitors who sign up at banix.in to provide a username and email
            address. Those who engage in transactions with Banix are asked to
          ...
          <p>
            ...
            websites. Banix may display this information publicly or provide it
            to others. However, Banix does not disclose personally-identifying
          ...
          <p>
            ...
            services available at Banix’s websites, and (ii) that have agreed
            ...
            country; by using Banix’s websites, you consent to the transfer of
            such information to them. Banix will not rent or sell potentially
            ...
            organizations, as described above, Banix discloses potentially
            ...
            request, or when Banix believes in good faith that disclosure is
            reasonably necessary to protect the property or rights of Banix,
            third parties or the public at large. If you are a registered user
            of an Banix website and have supplied your email address, Banix may
            ...
            on with Banix and our products. If you send us a request (for
            example via email or via one of our feedback mechanisms), we reserve
            the right to publish it in order to help us clarify or respond to
            your request or to help us support other users. Banix takes all
          ...
          <p>
            ...
            website each time the visitor returns. Banix uses cookies to help
            Banix identify and track visitors, their usage of Banix website, and
            their website access preferences. Banix visitors who do not wish to
            have cookies placed on their computers should set their browsers to
            refuse cookies before using Banix’s websites, with the drawback that
            certain features of Banix’s websites may not function properly
            without the aid of cookies.
          </p>
          <h3>Business Transfers</h3>
          <p>
            If Banix, or substantially all of its assets, were acquired, or in
            the unlikely event that Banix goes out of business or enters
            ...
            transfers may occur, and that any acquirer of Banix may continue to
          ...
          <p>
            ...
            cookies by Banix and does not cover the use of cookies by any
            advertisers.
          </p>
          <h3>Privacy Policy Changes </h3>
          <p>
            Although most changes are likely to be minor, Banix may change its
            Privacy Policy from time to time, and in Banix’s sole discretion.
            Banix encourages visitors to frequently check this page for any
            changes to its Privacy Policy. If you have a banix.in account, you
