...
const SitePageSupport = () => {
    const breadcrumb = [
        { title: "Home", url: "/" },
        { title: "Support", url: "/site/support" },
    ];
    return (
        <div>
            <Helmet>
                <title>{`Support — Banix`}</title>
            </Helmet>
            <PageBreadcrumb breadcrumb={breadcrumb} />
            <div className="document">
                <div className="document__header">
                    <h2 className="document__title">Support</h2>
                ...
                <div className="document__content typography">
                    ...
                    <p>
                        ...
                        love to help you resolve any issues. We want you to have
                        a positive experience every time you shop with Banix.
                        Please let us know if you have received any defected
                        item by contacting us.
                        <br />
                        This policy is only valid for naturally defected item as
                        that counts as a production error. The warranty does not
                        cover Normal wear and tear, defects caused by
                        owner&#39;s usage like accidental drops, failure of
                        installation, carelessness by the user, mishandled,
                        altered, modifies or misused.
                        <br />
                        Items must be requested to be warranted within the
                        mentioned days and the purchase date to be considered
                        for a defect review, otherwise it will not be eligible
                        for any warranties.
                        <br />
                        ...
                        *Terms &amp; Conditions apply*
                        ...
                        returned to its original specifications or replace it
                        with a product of same or higher value, if the original
